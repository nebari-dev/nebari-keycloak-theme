    ...
    <DialogPortal {...portalProps}>
      ...
      >
        <DialogPrimitive.Popup
          ...
          {...props}
        >
          {/* Cast required in this project only: the vendored
              `src/admin/i18next.d.ts` sets react-i18next's
              `allowObjectInHTMLChildren: true`, which widens every element's
              `children` type globally. See the README's registry note. */}
